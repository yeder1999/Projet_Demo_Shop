...
public class PaymentPom {
    ...
    private By paymentMethodContinue =
            By.cssSelector("input.payment-method-next-step-button");

    private By creditCardType =
            By.id("CreditCardType");

    private By cardholderName =
            By.id("CardholderName");

    private By cardNumber =
            By.id("CardNumber");

    private By expireMonth =
            By.id("ExpireMonth");

    private By expireYear =
            By.id("ExpireYear");
    ...
    private By paymentInfoContinue =
            By.cssSelector("input.payment-info-next-step-button");

    private By confirmOrderButton =
            By.cssSelector("input.confirm-order-next-step-button");
    ...
    public void selectExpireMonth(String month) {
        Select select = new Select(
                driver.findElement(expireMonth)
        );
